...
int main()
{
  ...
  while (result) {
    ...
    cams.push_back(new SequenceCapture(device++));
  ...
  // add video
  cams.push_back(new SequenceCapture("../../data/video/swings1.avi"));
  flipped_x.push_back(0); flipped_y.push_back(0); brightness.push_back(0);
  cams.push_back(new SequenceCapture("../../data/pictures/swings1/"));
  flipped_x.push_back(0); flipped_y.push_back(0); brightness.push_back(0);
